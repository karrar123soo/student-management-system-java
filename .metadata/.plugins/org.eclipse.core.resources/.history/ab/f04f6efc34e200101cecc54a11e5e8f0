...
public class tableprint {
	...
	public static void main(String[] args)   {
                ...
                //Print single cell
                WebElement element = driver.findElement(By.xpath("/table[@name='BookTable']/tbody/tr[6]/td[2]"));
                ...
                java.util.List<WebElement> column = driver.findElements(By.xpath("//table[@name = 'BookTable']/tbody/tr[1]/th"));
                System.out.println("Total column in table is -->" +Rows.size());
